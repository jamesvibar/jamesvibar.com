...
gulp.task('init-watch', () => {
    ...
    $.watch('src/images/**/*.svg', () => gulp.start('svg'))  
    $.watch('src/lambda/**/*', () => gulp.start('build-functions'))  
})

gulp.task('build', () => {
    runSequence('pub-delete', ['sass', 'js', 'fonts', 'images', 'svg', 'build-functions'], 'hugo')
})

gulp.task('build-preview', () => {
    runSequence('pub-delete', ['sass', 'js', 'fonts', 'images', 'svg', 'build-functions'], 'hugo-preview')
})
...
gulp.task('images', () => {
    ...
    return gulp.src('src/images/**/*.{png,jpg,jpeg,gif,webp,ico}')
